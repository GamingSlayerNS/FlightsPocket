document.addEventListener("DOMContentLoaded", () => {
  ...
  if (contactForm) {
    contactForm.addEventListener("submit", async (e) => {
      ...
      if (phpRunning) {
        const res = await fetch("/php/save-contact.php", {
          method: "POST",
      ...
      alert(`Form submitted successfully, but the PHP server is not running. Therefore, you can download the JSON data instead.\n\n${alertText}`);
      downloadContacts(contact);
    });
  }
});

async function downloadContacts(contact) {
