...
<html lang="en">
    <head>
        ...
        <title>Contact Us - Flights Pocket</title>
        <link rel="stylesheet" href="src/mystyle.css" />
        <script src="hooks/app.js"></script>
        <script src="hooks/contact.js"></script>
    </head>
    <body>
        <header>
            ...
            <div class="container">
                ...
                <form id="contact-form">
                    ...
                    <div class="flex-row">
                        ...
                        <div class="radio">
                            <div>
                                <input type="radio" id="male" name="gender" value="Male" name="male" required />
                                <label for="male">Male</label>
                            </div>
                            <div>
                                <input type="radio" id="female" name="gender" name="female" value="Female" />
                ...
                <div id="contact-errors" role="alert" aria-live="polite"></div>
            </div>
        </main>
        <footer>
            <p>
